import sys
from TestingFunctions import build_and_save_filtration, make_filtration_movie,make_persistence_diagram, frames_to_movie
...
if test == 1:
	...
	make_filtration_movie(
		...
		"2d_movie_start_test.mp4",      # output filename
	...
	# frames_to_movie('ffmpeg_test.mp4', 5)
    #
	# make_persistence_diagram(
	# 	in_data_file_name,
	# 	"persistence_diagram_start_test.png",
	# 	build_filt_params
	# )
