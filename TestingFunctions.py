...
def make_filtration_movie(
    ...
    FiltrationPlotter.make_movie_frames(title_block_info, color_scheme, alpha, dpi, camera_angle, max_frames, hide_1simplexes)
    frames_to_movie(out_file_name, framerate)
